    ...
    >
      ...
      <CardContent>
        <Table>
          ...
          >
            <TableCell>
              This is still not test data from the database.
            </TableCell>
  ...
  return (
    <>
      {!userView ? (
                ...
                <TableBody>
                  {(rowsPerPage > 0
                    ...
                    >
                      ...
                      <TableCell
                        align='right'
                        style={{ width: 160, textDecoration: "undeerline" }}
                      >
                        <button onClick={() => handleUserCard(row)}>
                          View Full
                        </button>
                      </TableCell>
                    </TableRow>
        ...
        <UserCard user={card} setUserView={setUserView} />
      )}
    </>
  );
}
