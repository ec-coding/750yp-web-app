          ...
          >
            <Box sx={style}>
              <Grid container alignItems="center" justifyContent="center">
                <Grid xs={12} sm={6} container alignItems="center" justifyContent="center" sx={{ marginBottom: { xs: 2, sm: 0 } }}>
                  <div className='flex-initial bio-panel space-y-8'>
                    <div className="w-60 h-60 rounded-full overflow-hidden border-2 border-white">
                ...
                <Grid xs={12} sm={6} alignItems="center" justifyContent="center">
                  <Box sx={{ border: '2px solid black' }} padding={4}>
                    <Typography variant="body1" sx={{ fontSize: { xs: 16, sm: 18 } }}>
                      <p>{person.tag}</p>
                    </Typography>
                  </Box>
                </Grid>
