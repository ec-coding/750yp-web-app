    ...
    <>
      <div className="h-screen w-screen overflow-x-hidden">
        ...
        <Container maxWidth={false} disableGutters>
          <Grid className='bg-sky-200'>
            <Grid container alignItems="center" padding={0} sx={{ maxWidth: 1280 }} marginX={'auto'} paddingY={5}>
              ...
              <Grid xs={12} sm={6} container alignItems="center" justifyContent="space-between" margin={0} paddingY={3}>
                <CardMedia component="img" image="https://i.imgur.com/ZVLTYe8.jpg" alt="750YP" className='hero-image' sx={{ border: '4px solid white', borderRadius: '8px' }} />
              </Grid>
          ...
          <Grid className='text-4xl text-center font-bold my-10' sx={{ maxWidth: 1280 }} marginX={'auto'}>
            <Typography sx={{ fontSize: 18 }}>
            </Typography>
            <Divider variant="middle" sx={{ height: '3px', width: '200px', my: 4, mx: 'auto' }} />
          </Grid>

          <Grid className="space-y-16" sx={{ maxWidth: 1280 }} marginX={'auto'} marginBottom={5}>
