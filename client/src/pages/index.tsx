    ...
    <main className="min-h-screen">
      <div className='grid grid-cols-2 gap-12 my-0 mx-auto w-3/5 h-2/3' >
        <div className='col-span-1 flex flex-col justify-center items-start'>
          ...
          <h2 className='mb-8 text-lg'>Seamlessly create, promote, and track events of any scale, while delighting guests with easy RSVPS and real-time updates. Unleash the potential of memorable events with 750YP - where events come to life!</h2>
          ...
          :
          // eslint-disable-next-line @next/next/no-html-link-for-pages
          <a href="/api/auth/login" className="inline-block m-0 text-md px-4 py-2 w-32 flex justify-center flexleading-none border rounded text-white border-white bg-blue-500 hover:bg-blue-400 hover: mt-4 lg:mt-0">Join 750YP</a>
          }
        </div>
